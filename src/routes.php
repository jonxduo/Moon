...
Route::get('/admin/module/{id}/build', 'App\Http\Controllers\MoonController@build')->name('moon.build');
Route::get('/admin/module/{id}/upgrade', 'App\Http\Controllers\MoonController@upgrade')->name('moon.upgrade');
